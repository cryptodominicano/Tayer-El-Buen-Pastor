...
export default function Footer() {
  const handleWhatsAppClick = () => {
    window.gtag?.('event', 'whatsapp_click', { event_label: 'footer' });
  };

  return (
    <footer className="bg-iron text-white py-12 px-4 pb-28 md:pb-12">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Pages */}
          <div>
            <h4 className="font-semibold text-lg mb-4">Páginas</h4>
            <ul className="space-y-2 text-sm text-white/70">
              <li><a href="/por-que-elegirnos" className="hover:text-gold transition-colors">Por Qué Elegirnos</a></li>
